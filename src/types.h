...
enum edit {
  ...
  EDIT_JUMP_ROOM, EDIT_INFO, EDIT_EVENT, EDIT_EVENT_SET, EDIT_EVENT2CON,
  ...
  EDIT_LEVEL_MIRROR_CONS, EDIT_LEVEL_MIRROR_LINKS, EDIT_LEVEL_MIRROR_BOTH, EDIT_LEVEL_JUMP, EDIT_LEVEL_EXCHANGE,
};
