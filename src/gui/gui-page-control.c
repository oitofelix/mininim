...
button_action_cb (Ihandle *ih)
{
  ...
  else if (ih == l_button) mr_page_trans (&global_mr, LEFT);
  else if (ih == r_button) mr_page_trans (&global_mr, RIGHT);
  else if (ih == a_button) mr_page_trans (&global_mr, ABOVE);
  else if (ih == b_button) mr_page_trans (&global_mr, BELOW);
