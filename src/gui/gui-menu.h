...
#define NAV_AL_ICON "data/icons/nav-al.png"
#define NAV_AR_ICON "data/icons/nav-ar.png"
#define NAV_BL_ICON "data/icons/nav-bl.png"
#define NAV_BR_ICON "data/icons/nav-br.png"
