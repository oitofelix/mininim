...
load_icons (void)
{
  ...
  LOAD_ICON (HOME_ICON);
  LOAD_ICON (DEFRAG_ICON);
  LOAD_ICON (CLEAN_ICON);
  LOAD_ICON (OUT_ICON);
  LOAD_ICON (IN_ICON);
  ...
  LOAD_ICON (PLACE_SEL_LAST_ICON);
  LOAD_ICON (PLACE_SEL_UNLOCK_ICON);
  LOAD_ICON (EXCHANGE_LINKS_ICON);
  LOAD_ICON (EXCHANGE_TILES_ICON);
}
...
unload_icons (void)
{
  ...
  UNLOAD_ICON (VIEW_RING_NEW_ICON);
  ...
  UNLOAD_ICON (DEFRAG_ICON);
  UNLOAD_ICON (CLEAN_ICON);
  UNLOAD_ICON (OUT_ICON);
  UNLOAD_ICON (IN_ICON);
  ...
  UNLOAD_ICON (PLACE_SEL_LAST_ICON);
  UNLOAD_ICON (PLACE_SEL_UNLOCK_ICON);
  UNLOAD_ICON (EXCHANGE_LINKS_ICON);
  UNLOAD_ICON (EXCHANGE_TILES_ICON);
}
