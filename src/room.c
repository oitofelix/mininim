                 ...
                 enum em em, enum vm vm)
{
  ...
  case WALL:
    if (con_caching) draw_wall_part (bitmap, p, "BASE");
                 ...
                 enum em em, enum vm vm)
{
  ...
  case WALL:
    if (con_caching) draw_wall_part (bitmap, p, "LEFT");
                  ...
                  enum em em, enum vm vm)
{
  ...
  case WALL: draw_wall_part (bitmap, p, "RIGHT"); break;
                ...
                enum em em, enum vm vm)
{
  ...
  case WALL: draw_wall_part (bitmap, p, "TOP"); break;
