...
static struct level level_1 = {
  ...
  .con = {
    ...
    [23] =
    {{{NO_FLOOR}, {FLOOR,BRICKS_02}, {ARCH_TOP_LEFT}, {ARCH_TOP_RIGHT}, {ARCH_TOP_MID},
      {ARCH_TOP_SMALL}, {ARCH_TOP_MID}, {ARCH_TOP_SMALL}, {ARCH_TOP_MID}, {ARCH_CARPET_RIGHT_01}},
    ...
    {{{NO_FLOOR}, {NO_FLOOR}, {NO_FLOOR}, {NO_FLOOR}, {FLOOR},
      {NO_FLOOR}, {NO_FLOOR}, {NO_FLOOR}, {NO_FLOOR}, {FLOOR}},
     {{NO_FLOOR}, {NO_FLOOR}, {NO_FLOOR}, {NO_FLOOR}, {ARCH_CARPET_RIGHT_02},
