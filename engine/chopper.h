...
void draw_chopper_left_01 (ALLEGRO_BITMAP *bitmap, struct pos *p);
void draw_chopper_left_02 (ALLEGRO_BITMAP *bitmap, struct pos *p);
void draw_chopper_left_03 (ALLEGRO_BITMAP *bitmap, struct pos *p);
void draw_chopper_left_04 (ALLEGRO_BITMAP *bitmap, struct pos *p);
void draw_chopper_left_05 (ALLEGRO_BITMAP *bitmap, struct pos *p);
void draw_chopper_left_fg (ALLEGRO_BITMAP *bitmap, struct pos *p, struct frame *f);
void
draw_chopper_fg (ALLEGRO_BITMAP *bitmap, struct pos *p);
void draw_chopper_fg_01 (ALLEGRO_BITMAP *bitmap, struct pos *p);
void draw_chopper_fg_02 (ALLEGRO_BITMAP *bitmap, struct pos *p);
void draw_chopper_fg_03 (ALLEGRO_BITMAP *bitmap, struct pos *p);
void draw_chopper_fg_04 (ALLEGRO_BITMAP *bitmap, struct pos *p);
void draw_chopper_fg_05 (ALLEGRO_BITMAP *bitmap, struct pos *p);
